...
function WelcomeSection({ userName, currentDate, supportingText, sideText }) {
  return (
    <section className="welcome-section flex flex-col sm:flex-row items-start justify-between gap-4 px-4 md:px-8 pt-0 pb-5">
      <div>
      ...
      <div className="welcome-safety-group flex flex-col items-end gap-2">
        <div className="welcome-safety-row flex items-stretch justify-end gap-2 flex-wrap">
